 ...
 * 
 * Usage:
 *   DATABASE_URL=postgresql://... tsx src/db/apply-migration.ts migrations/0002_add_media_files_table.sql
 */
...
async function applyMigration(migrationFile: string) {
  ...
  try {
    ...
    // Execute raw SQL - split by semicolons and execute each statement
