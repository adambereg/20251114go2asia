    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <PersonalWelcome
          ...
          teamMembers={7}
          activeQuests={2}
          onContinueQuest={() => console.log('Continue quest')}
          onNewVouchers={() => console.log('New vouchers')}
          onReferralLink={() => console.log('Referral link')}
        />
      </section>
      ...
      <section className="bg-slate-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm sm:text-base text-slate-600">
              Самые посещаемые места и активности
            </p>
          </div>
      ...
      <section className="bg-slate-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm sm:text-base text-slate-600">
              Больше чем просто информация о путешествиях, наша экосистема
              возможностью
            </p>
          </div>
